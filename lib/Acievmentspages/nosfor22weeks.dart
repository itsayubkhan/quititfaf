...
class for22weeks extends StatefulWidget{
  @override
  State<for22weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for22weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 153
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('21',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 21 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 153
          ? Container(
        height: 90,
        child: Center(
          child: Container(
