...
class for28weeks extends StatefulWidget{
  @override
  State<for28weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for28weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 195
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('28',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 28 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 195
          ? Container(
        height: 90,
        child: Center(
          child: Container(
