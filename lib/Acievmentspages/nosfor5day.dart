...
class for5days extends StatefulWidget{
  @override
  State<for5days> createState() => _CalenderState();
}

class _CalenderState extends State<for5days> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 5
          ? Column(
        children: [
          SizedBox(height: 100,),
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 5
          ? Container(
        height: 90,
        child: Center(
          child: Container(
