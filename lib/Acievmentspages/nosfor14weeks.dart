...
class for14weeks extends StatefulWidget{
  @override
  State<for14weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for14weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 98
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('14',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 14 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 98
          ? Container(
        height: 90,
        child: Center(
          child: Container(
