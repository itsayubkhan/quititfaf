  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 100,),
          Center(child: Image.asset('assets/img/IMG_20240519_145256.jpg',
            width: 200,)),
          SizedBox(height: 20,),
          Text('Saturday night fever',style: TextStyle(fontSize: 16,
              color:
              Colors.white),),
          SizedBox(height: 5,),
          Text('10 cigrattes non-smoked',style: TextStyle(fontSize: 16,color:
          Colors.white),),
          Row(
