...
class for6weeks extends StatefulWidget{
  @override
  State<for6weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for6weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 42
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('6',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 6 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 42
          ? Container(
        height: 90,
        child: Center(
          child: Container(
