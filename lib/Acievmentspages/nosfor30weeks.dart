...
class for30weeks extends StatefulWidget{
  @override
  State<for30weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for30weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 209
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('30',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 30 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 209
          ? Container(
        height: 90,
        child: Center(
          child: Container(
