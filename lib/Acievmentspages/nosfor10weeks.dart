...
class for10weeks extends StatefulWidget{
  @override
  State<for10weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for10weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 70
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('10',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 10 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 70
          ? Container(
        height: 90,
        child: Center(
          child: Container(
