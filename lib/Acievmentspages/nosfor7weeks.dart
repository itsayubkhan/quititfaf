...
class for7weeks extends StatefulWidget{
  @override
  State<for7weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for7weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 49
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('7',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 7 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 49
          ? Container(
        height: 90,
        child: Center(
          child: Container(
