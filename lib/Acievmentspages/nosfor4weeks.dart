...
class for4weeks extends StatefulWidget{
  @override
  State<for4weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for4weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 28
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('4',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 4 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 28
          ? Container(
        height: 90,
        child: Center(
          child: Container(
