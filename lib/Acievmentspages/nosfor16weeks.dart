...
class for16weeks extends StatefulWidget{
  @override
  State<for16weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for16weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 112
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('16',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 16 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 112
          ? Container(
        height: 90,
        child: Center(
          child: Container(
