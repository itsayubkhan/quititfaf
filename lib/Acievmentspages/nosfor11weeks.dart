...
class for11weeks extends StatefulWidget{
  @override
  State<for11weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for11weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 77
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('11',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 11 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 77
          ? Container(
        height: 90,
        child: Center(
          child: Container(
