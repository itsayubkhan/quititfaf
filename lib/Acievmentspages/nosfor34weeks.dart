...
class for34weeks extends StatefulWidget{
  @override
  State<for34weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for34weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 237
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('34',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 34 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 237
          ? Container(
        height: 90,
        child: Center(
          child: Container(
