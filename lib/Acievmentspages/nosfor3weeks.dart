...
class for3weeks extends StatefulWidget{
  @override
  State<for3weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for3weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 21
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('3',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 3 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 21
          ? Container(
        height: 90,
        child: Center(
          child: Container(
