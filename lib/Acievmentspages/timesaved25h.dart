...
class timesaved25h extends StatefulWidget{
  @override
  State<timesaved25h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved25h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 25
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('25',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('time save 25h',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.timeSaved >= 25
          ? Container(
        height: 90,
        child: Center(
          child: Container(
