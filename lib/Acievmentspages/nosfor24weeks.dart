...
class for24weeks extends StatefulWidget{
  @override
  State<for24weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for24weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 167
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('24',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 24 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 167
          ? Container(
        height: 90,
        child: Center(
          child: Container(
