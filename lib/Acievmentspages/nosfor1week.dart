...
class for1week extends StatefulWidget{
  @override
  State<for1week> createState() => _CalenderState();
}

class _CalenderState extends State<for1week> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 7
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('Seven-Day Sentinel',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 1 week',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 7
          ? Container(
        height: 90,
        child: Center(
          child: Container(
