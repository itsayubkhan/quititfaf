...
class timesaved70h extends StatefulWidget{
  @override
  State<timesaved70h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved70h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 70
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('70',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('time save 70h',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.timeSaved >= 70
          ? Container(
        height: 90,
        child: Center(
          child: Container(
