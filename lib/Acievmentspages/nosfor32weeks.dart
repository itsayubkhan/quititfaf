...
class for32weeks extends StatefulWidget{
  @override
  State<for32weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for32weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 223
          ? Column(
        children: [
          SizedBox(height: 100,),
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 223
          ? Container(
        height: 90,
        child: Center(
          child: Container(
