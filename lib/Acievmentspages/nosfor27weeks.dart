...
class for27weeks extends StatefulWidget{
  @override
  State<for27weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for27weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 188
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('27',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 27 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 188
          ? Container(
        height: 90,
        child: Center(
          child: Container(
