...
class for40weeks extends StatefulWidget{
  @override
  State<for40weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for40weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 280
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('40',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 40 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 280
          ? Container(
        height: 90,
        child: Center(
          child: Container(
