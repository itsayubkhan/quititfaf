...
class for35weeks extends StatefulWidget{
  @override
  State<for35weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for35weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 244
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('35',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 35 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 244
          ? Container(
        height: 90,
        child: Center(
          child: Container(
