...
class timesaved6h extends StatefulWidget{
  @override
  State<timesaved6h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved6h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 6
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('6',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('time save 6h',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.timeSaved >= 6
          ? Container(
        height: 90,
        child: Center(
          child: Container(
