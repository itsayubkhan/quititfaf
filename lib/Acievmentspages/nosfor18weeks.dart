...
class for18weeks extends StatefulWidget{
  @override
  State<for18weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for18weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 126
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('18',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 18 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 126
          ? Container(
        height: 90,
        child: Center(
          child: Container(
