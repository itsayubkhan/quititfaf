...
class Clothesoff extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 100,),
          Center(child: Image.asset('assets/img/IMG_20240519_145312.jpg',
            width: 200,)),
          SizedBox(height: 20,),
          Text('Clothes off',style: TextStyle(fontSize: 16,
              color:
              Colors.white),),
          SizedBox(height: 5,),
          Text('15 cigrattes non-smoked',style: TextStyle(fontSize: 16,color:
          Colors.white),),
          Row(
