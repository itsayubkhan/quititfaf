...
class for8weeks extends StatefulWidget{
  @override
  State<for8weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for8weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 56
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('8',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 8 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 56
          ? Container(
        height: 90,
        child: Center(
          child: Container(
