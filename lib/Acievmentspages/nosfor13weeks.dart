...
class for13weeks extends StatefulWidget{
  @override
  State<for13weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for13weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 91
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('13',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 13 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 91
          ? Container(
        height: 90,
        child: Center(
          child: Container(
