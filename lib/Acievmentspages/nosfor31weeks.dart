...
class for31weeks extends StatefulWidget{
  @override
  State<for31weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for31weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 216
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('31',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 31 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 216
          ? Container(
        height: 90,
        child: Center(
          child: Container(
