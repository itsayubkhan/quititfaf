...
class for12weeks extends StatefulWidget{
  @override
  State<for12weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for12weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 84
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('12',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 12 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 84
          ? Container(
        height: 90,
        child: Center(
          child: Container(
