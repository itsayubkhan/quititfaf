...
class for15weeks extends StatefulWidget{
  @override
  State<for15weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for15weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 105
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('15',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 15 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 105
          ? Container(
        height: 90,
        child: Center(
          child: Container(
