...
class timesaved2h extends StatefulWidget{
  @override
  State<timesaved2h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved2h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 2
          ? Column(
        children: [
          SizedBox(height: 100,),
