...
class timesaved40h extends StatefulWidget{
  @override
  State<timesaved40h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved40h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 40
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('40',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('time save 40h',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.timeSaved >= 40
          ? Container(
        height: 90,
        child: Center(
          child: Container(
