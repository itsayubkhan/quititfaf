...
class for39weeks extends StatefulWidget{
  @override
  State<for39weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for39weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 273
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('39',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 39 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 273
          ? Container(
        height: 90,
        child: Center(
          child: Container(
