...
class for29weeks extends StatefulWidget{
  @override
  State<for29weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for29weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 202
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('29',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 29 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 202
          ? Container(
        height: 90,
        child: Center(
          child: Container(
