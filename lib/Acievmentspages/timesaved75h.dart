...
class timesaved75h extends StatefulWidget{
  @override
  State<timesaved75h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved75h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 75
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('75',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('time save 75h',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.timeSaved >= 75
          ? Container(
        height: 90,
        child: Center(
          child: Container(
