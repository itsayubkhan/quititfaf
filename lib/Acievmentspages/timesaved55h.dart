...
class timesaved55h extends StatefulWidget{
  @override
  State<timesaved55h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved55h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 55
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('55',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('time save 55h',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.timeSaved >= 55
          ? Container(
        height: 90,
        child: Center(
          child: Container(
