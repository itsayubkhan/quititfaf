...
class for25weeks extends StatefulWidget{
  @override
  State<for25weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for25weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 174
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('25',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 25 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 174
          ? Container(
        height: 90,
        child: Center(
          child: Container(
