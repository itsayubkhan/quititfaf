...
class for10days extends StatefulWidget{
  @override
  State<for10days> createState() => _CalenderState();
}

class _CalenderState extends State<for10days> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 10
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('Ten-Day Trailblazer',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 10 days',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 10
          ? Container(
        height: 90,
        child: Center(
          child: Container(
