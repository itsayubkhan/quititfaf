...
class timesaved60h extends StatefulWidget{
  @override
  State<timesaved60h> createState() => _CalenderState();
}

class _CalenderState extends State<timesaved60h> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.timeSaved >= 60
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('60',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('time save 60h',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.timeSaved >= 60
          ? Container(
        height: 90,
        child: Center(
          child: Container(
