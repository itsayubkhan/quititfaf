...
class for36weeks extends StatefulWidget{
  @override
  State<for36weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for36weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 251
          ? Column(
        children: [
          SizedBox(height: 100,),
          ...
          Text('36',style: TextStyle(fontSize: 16,
              ...
              Colors.white),),
          SizedBox(height: 5,),
          Text('No smoking for 36 weeks',style: TextStyle(fontSize: 16,color:
          Colors.grey[400]),),
          Row(
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 251
          ? Container(
        height: 90,
        child: Center(
          child: Container(
