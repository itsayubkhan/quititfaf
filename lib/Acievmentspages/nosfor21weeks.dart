...
class for21weeks extends StatefulWidget{
  @override
  State<for21weeks> createState() => _CalenderState();
}

class _CalenderState extends State<for21weeks> {
  final gs = GetStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataController.daysSinceQuitting >= 146
          ? Column(
        children: [
          SizedBox(height: 100,),
      ...
      bottomNavigationBar: dataController.daysSinceQuitting >= 146
          ? Container(
        height: 90,
        child: Center(
          child: Container(
